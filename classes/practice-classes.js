...
class Player extends Character {
  ...
  defend(oppAttackLevel) {
    let currHealthLevel = this.healthLevel - oppAttackLevel
    if(currHealthLevel > 0) {
      let fight = {attackStrength:oppAttackLevel, remainingHealth:currHealthLevel, message:`${this.name} is still in the fight!`}
      return fight
    } else {
...
fireSpitter.addSuperPower(`boogie laugh`)
